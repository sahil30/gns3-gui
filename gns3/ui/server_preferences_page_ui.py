...
#
# Created: Wed May  6 16:11:07 2015
...
class Ui_ServerPreferencesPageWidget(object):
    def setupUi(self, ServerPreferencesPageWidget):
        ...
        self.gridLayout_2.addWidget(self.uiRemoteServerProtocolLabel, 6, 0, 1, 1)
        spacerItem3 = QtWidgets.QSpacerItem(390, 12, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.uiRemoteServersTreeWidget.setColumnCount(3)
        self.uiRemoteServersTreeWidget.setObjectName("uiRemoteServersTreeWidget")
        self.uiRemoteServersTreeWidget.headerItem().setText(0, "1")
        self.uiRemoteServersTreeWidget.headerItem().setText(1, "2")
        self.uiRemoteServersTreeWidget.headerItem().setText(2, "3")
        ...
        self.uiRemoteServerComboBox = QtWidgets.QComboBox(self.uiRemoteTabWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.uiRemoteServerComboBox.sizePolicy().hasHeightForWidth())
        self.uiRemoteServerComboBox.setSizePolicy(sizePolicy)
        self.uiRemoteServerComboBox.setObjectName("uiRemoteServerComboBox")
        self.uiRemoteServerComboBox.addItem("")
        self.uiRemoteServerComboBox.addItem("")
        self.gridLayout_2.addWidget(self.uiRemoteServerComboBox, 7, 0, 1, 1)
    ...
    def retranslateUi(self, ServerPreferencesPageWidget):
        ...
        self.uiRemoteServerComboBox.setCurrentText(_translate("ServerPreferencesPageWidget", "HTTP"))
        self.uiRemoteServerComboBox.setItemText(0, _translate("ServerPreferencesPageWidget", "HTTP"))
        self.uiRemoteServerComboBox.setItemText(1, _translate("ServerPreferencesPageWidget", "SSH"))
